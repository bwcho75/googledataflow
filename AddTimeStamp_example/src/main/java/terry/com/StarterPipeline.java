...
public class StarterPipeline {
  ...
  public static void main(String[] args) {
   ...
   PCollection <String> pc =  p.apply(Create.of("Hello", "World"));
   pc.apply(ParDo.of(new DoFn<String, String>() {
        public void processElement(ProcessContext c) {
            // add time stamp
            org.joda.time.Instant logTimeStamp = org.joda.time.Instant.now();
